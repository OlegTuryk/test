...
import com.chatbuddy.dto.message.WriteToUserRequestDto;
import com.chatbuddy.mapper.MessageMapper;
import com.chatbuddy.model.Chat;
import com.chatbuddy.service.ChatGptService;
import com.chatbuddy.service.ChatService;
import com.chatbuddy.service.impl.ChatGptServiceImpl;
import com.chatbuddy.service.impl.ChatServiceImpl;
...
public class ChatBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        if (update.hasMessage()) {
            ...
            try {
                ...
                com.chatbuddy.model.Message savedMessage
    ...
    public MessageResponseDto writeToUser(Long telegramChatId, WriteToUserRequestDto message) {
        ...
        com.chatbuddy.model.Message updateMessage
